...
require'nvim-treesitter.configs'.setup {
  ensure_installed = { "bash", "clojure", "go", "python" }, -- one of "all", "maintained" (parsers with maintainers), or a list of languages
...
" map CTRL+W to copy selection (copy all if no selection)
map <C-c> :w !pbcopy<CR>
...
" map CTRL+E to trigger buffer evaluation (fireplace)
map <C-e> :%Eval<CR>
